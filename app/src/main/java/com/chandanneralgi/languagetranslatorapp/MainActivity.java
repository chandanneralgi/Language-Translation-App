package com.chandanneralgi.languagetranslatorapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    String[] fromLanguages = {"From", "English","Kannada","Afrikaans","Arabic","Belarusian","Bengali","Catalan","Czech","Welsh","Hindi","Urdu"};

    String[] toLanguages = {"To", "English","Kannada","Afrikaans","Arabic","Belarusian","Bengali","Catalan","Czech","Welsh","Hindi","Urdu"};
    ...
    private void translateText(int fromLanguageCode, int tolanguageCode, String source){
        ...
        FirebaseTranslatorOptions options = new FirebaseTranslatorOptins.Builder()
        ...
        translator.downloadModelIfNeeded(conditions).addOnSuccessListener(new OnSuccessListener<Void>(){
            ...
            @Override
            public void onFailure(@NonNull Exception e){
                Toast.makeText(MainActivity.this, "Fail to download language Madal "+e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
